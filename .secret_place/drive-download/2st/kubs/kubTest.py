...
def make_mask(_frame):
    ...
    mask_2 = cv2.inRange(cutedFrame, (50, 50, 50), (220, 220, 220))
    ...
    mask_3 = cv2.inRange(cutedFrame, (62, 62, 62), (90, 90, 90))
        ...
        for l in range(2):
            for j in range(2):
                color_dict = {
                    ...
                    2: [(140, 155, 255), (80, 75, 200)],  # red
                    3: [(115, 215, 255), (70, 125, 220)],  # orange
                    4: [(75, 245, 245), (45, 215, 215)],  # yellow
                    5: [(135, 235, 75), (100, 180, 0)],  # green
                    6: [(260, 250, 20),(210, 190, 0)],  # cyan
                    7: [(255, 195, 95), (190, 160, 0)],  # blue
                    8: [(210, 155, 115),(175, 115, 75)],  # violet
                    9: [(255, 215, 255),(145, 125, 185)]  # pink
                }
...
cap = cv2.VideoCapture('output11.avi')
markNum = {6, 5, 2, 1}
while True:
    ret, frame = cap.read()
    if not ret:
        ...
        for i in range(1, len(contours_1)):
            ...
            if len(colorsList) != 0:
                ...
                for string_x in colorsList:
                    colorMarker += str(string_x)
                cv2.circle(cutedFrame, ((x + w//2)-10, (y + h//2)-10), 2, (255, 255, 0), 2)
                cv2.putText(cutedFrame, str(colorMarker) , ((x + w//2), (y + h//2)), font, 0.4, (255, 0, 255))
