...
def extract_and_concatenate(image_list):
    ...
    for img in image_list:
        ...
        piece = img[150:500, 400:570].copy()  # копия на случай, если потребуется избежать ссылок на исходный массив
...
def capture_images(robot):
    ...
    # Передаём изображения образца с разных ракурсов для обработки нейросетью
    predict_sample_type(images)
