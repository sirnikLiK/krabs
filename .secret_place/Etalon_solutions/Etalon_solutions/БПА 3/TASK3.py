...
model = yolopy.Model('best.tmfile', use_uint8=True, use_timvx=True, cls_num=1)
...
algorithm = [CROSS_RIGHT, CROSS_RIGHT, CROSS_RIGHT, CROSS_STRAIGHT]
current_step = 0
