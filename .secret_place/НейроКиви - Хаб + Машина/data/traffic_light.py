...
try:
    ...
    while True:
        ...
        traffic_light = list(filter(lambda e: e[0] == 7, data))[0]

        traffic_light_img = frame[traffic_light[1][0]-20:traffic_light[1][2]+40, traffic_light[1][1]-20:traffic_light[1][3]+40]
